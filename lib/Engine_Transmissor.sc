    ...
    alloc {
        ...
        inputSynth = {
            ...
            rf = AllpassC.ar(rf, 0.01,
                ...
                (LFNoise1.kr(0.05).range(0.1, 0.3) * (1.0 + (smear * 2.0))).clip(0.0, 0.5)
            );
            rf = AllpassC.ar(rf, 0.01,
