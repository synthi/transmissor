...
local fidelity_presets = {
  [1] = { name = "PRISTINE",
    ...
    { "saturation", 0 }, { "harmonic_drive", 0 },     { "multipath", 0.0 }, { "doppler", 0.0 }, { "fade_rate", 0.0 },
  ...
  [2] = { name = "CLEAN",
    ...
    { "saturation", 0.01 }, { "harmonic_drive", 0.01 },     { "multipath", 0.02 }, { "doppler", 0.1 }, { "fade_rate", 0.05 },
  ...
  [3] = { name = "GOOD",
    ...
    { "saturation", 0.02 }, { "harmonic_drive", 0.02 },     { "multipath", 0.05 }, { "doppler", 0.3 }, { "fade_rate", 0.1 },
  ...
  [4] = { name = "FAIR",
    ...
    { "saturation", 0.03 }, { "harmonic_drive", 0.04 },     { "multipath", 0.1 }, { "doppler", 0.6 }, { "fade_rate", 0.15 },
  ...
  [5] = { name = "AVERAGE",
    ...
    { "saturation", 0.05 }, { "harmonic_drive", 0.06 },     { "multipath", 0.15 }, { "doppler", 1.0 }, { "fade_rate", 0.2 },
  ...
  [6] = { name = "POOR",
    ...
    { "saturation", 0.07 }, { "harmonic_drive", 0.08 },     { "multipath", 0.25 }, { "doppler", 1.8 }, { "fade_rate", 0.3 },
  ...
  [7] = { name = "BAD",
    ...
    { "saturation", 0.1 }, { "harmonic_drive", 0.12 },     { "multipath", 0.35 }, { "doppler", 3.0 }, { "fade_rate", 0.4 },
  ...
  [8] = { name = "DEGRADED",
    ...
    { "saturation", 0.15 }, { "harmonic_drive", 0.18 },     { "multipath", 0.5 }, { "doppler", 5.0 }, { "fade_rate", 0.5 },
  ...
  [9] = { name = "FRINGE",
    ...
    { "saturation", 0.2 }, { "harmonic_drive", 0.25 },     { "multipath", 0.75 }, { "doppler", 12.0 }, { "fade_rate", 0.75 },
  ...
  [10] = { name = "VOID",
    ...
    { "saturation", 0.3 }, { "harmonic_drive", 0.35 },     { "multipath", 0.85 }, { "doppler", 16.0 }, { "fade_rate", 0.85 },
  ...
  [11] = { name = "XTINA",
    ...
    { "saturation", 0.4 }, { "harmonic_drive", 0.4 },     { "multipath", 0.9 }, { "doppler", 18.0 }, { "fade_rate", 0.9 },
  ...
  [12] = { name = "XBAJA",
    ...
    { "saturation", 0.5 }, { "harmonic_drive", 0.5 },     { "multipath", 0.92 }, { "doppler", 19.0 }, { "fade_rate", 0.92 },
  ...
  [13] = { name = "XFRINGE",
    ...
    { "saturation", 0.6 }, { "harmonic_drive", 0.6 },     { "multipath", 0.95 }, { "doppler", 19.5 }, { "fade_rate", 0.95 },
  ...
  [14] = { name = "XVOID",
    ...
    { "saturation", 0.7 }, { "harmonic_drive", 0.7 },     { "multipath", 0.97 }, { "doppler", 20.0 }, { "fade_rate", 0.97 },
  ...
  [15] = { name = "EDGE",
    ...
    { "saturation", 0.8 }, { "harmonic_drive", 0.8 },     { "multipath", 0.98 }, { "doppler", 20.0 }, { "fade_rate", 0.98 },
  ...
  [16] = { name = "VOIDMAX",
    ...
    { "saturation", 1.0 }, { "harmonic_drive", 1.0 },     { "multipath", 1.0 }, { "doppler", 20.0 }, { "fade_rate", 1.0 },
